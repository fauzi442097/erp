    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <div id="kt_app_sidebar_toggle"
                class="app-sidebar-toggle btn btn-sm btn-icon bg-body btn-color-gray-600 btn-active-color-primary w-30px h-30px ms-n2 me-4 d-none d-lg-flex"
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
                ...
                <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-350px"
                    ...
                    <form data-kt-search-element="form" class="mb-5 d-none d-lg-block w-100 position-relative mb-lg-0"
                        ...
                        <!--end::Icon-->
                        <!--begin::Input-->
                        <input type="text" class="border-0 search-input form-control h-lg-45px ps-13" name="search"
                    ...
                    <div data-kt-search-element="content"
                        class="overflow-hidden menu menu-sub menu-sub-dropdown w-300px w-md-350px py-7 px-7">
                        <!--begin::Wrapper-->
                        <div data-kt-search-element="wrapper">
                            ...
                            <div data-kt-search-element="results" class="d-none">
                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                    ...
                                    <h3 class="pb-5 m-0 fs-5 text-muted" data-kt-search-element="category-title">Users
                                    </h3>
                                    <!--end::Category title-->
                                    <!--begin::Item-->
                                    <a href="#"
                                        class="mb-5 d-flex text-dark text-hover-primary align-items-center">
                                        <!--begin::Symbol-->
                            ...
                            <div class="" data-kt-search-element="main">
                                ...
                                <div class="scroll-y mh-200px mh-lg-325px">
                                    ...
                                    <div class="mb-5 d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 fs-6 text-hover-primary fw-semibold">BoomApp
                                                by Keenthemes</a>
                                    ...
                                    <div class="mb-5 d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 fs-6 text-hover-primary fw-semibold">"Kept
                                    ...
                                    <div class="mb-5 d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 fs-6 text-hover-primary fw-semibold">"KPI
                                    ...
                                    <div class="mb-5 d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 fs-6 text-hover-primary fw-semibold">Project
                                                Reference FAQ</a>
                                    ...
                                    <div class="mb-5 d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 fs-6 text-hover-primary fw-semibold">"FitPro
                                                App Development</a>
                                            <span class="fs-7 text-muted fw-semibold">#84250</span>
                                        </div>
                                        <!--end::Title-->
                                    ...
                                    <div class="mb-5 d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 fs-6 text-hover-primary fw-semibold">Shopix
                                                Mobile App</a>
                                    ...
                                    <div class="mb-5 d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-gray-800 fs-6 text-hover-primary fw-semibold">"Landing
                                                UI Design" Launch</a>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        ...
                                        <span
                                            class="px-4 btn btn-sm btn-color-muted btn-active btn-active-primary">Users</span>
                                    </label>
                                    <!--end::Option-->
                                    <!--begin::Option-->
                                    <label>
                                        ...
                                        <span
                                            class="px-4 btn btn-sm btn-color-muted btn-active btn-active-primary">Orders</span>
                                    </label>
                                    <!--end::Option-->
                                    <!--begin::Option-->
                                    <label>
                                        ...
                                        <span
                                            class="px-4 btn btn-sm btn-color-muted btn-active btn-active-primary">Projects</span>
                                    </label>
                                    <!--end::Option-->
                                </div>
                                <!--end::Radio group-->
                            ...
                            <div class="mb-5">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        ...
                                        <span
                                            class="px-4 btn btn-sm btn-color-muted btn-active btn-active-primary">Any</span>
                                    </label>
                                    <!--end::Option-->
                                </div>
                                <!--end::Radio group-->
                        ...
                        <form data-kt-search-element="preferences" class="pt-1 d-none">
                            ...
                            <div class="pb-4 border-bottom">
                                <label
                                    ...
                                    <span
                                        class="text-gray-700 form-check-label fs-6 fw-semibold ms-0 me-2">Projects</span>
                            ...
                            <div class="py-4 border-bottom">
                                <label
                                    class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                    <span
                                        class="text-gray-700 form-check-label fs-6 fw-semibold ms-0 me-2">Targets</span>
                                    <input class="form-check-input" type="checkbox" value="1"
                                        checked="checked" />
                                </label>
                            </div>
                            ...
                            <div class="py-4 border-bottom">
                                <label
                                    class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                    <span class="text-gray-700 form-check-label fs-6 fw-semibold ms-0 me-2">Affiliate
                                        Programs</span>
                                    <input class="form-check-input" type="checkbox" value="1" />
                                </label>
                            </div>
                            ...
                            <div class="py-4 border-bottom">
                                <label
                                    class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                    <span
                                        class="text-gray-700 form-check-label fs-6 fw-semibold ms-0 me-2">Referrals</span>
                                    <input class="form-check-input" type="checkbox" value="1"
                                        checked="checked" />
                                </label>
                            </div>
                            ...
                            <div class="py-4 border-bottom">
                                <label
                                    class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                    <span
                                        class="text-gray-700 form-check-label fs-6 fw-semibold ms-0 me-2">Users</span>
                                    <input class="form-check-input" type="checkbox" value="1" />
                                </label>
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="pt-10 pb-0">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="pt-1 text-center text-gray-600 fw-semibold">Outlines keep
            ...
            <div class="app-navbar-item ms-2 ms-lg-6">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                    ...
                    <div class="py-10 d-flex flex-column flex-center bgi-no-repeat rounded-top px-9"
                        ...
                        <!--end::Title-->
                        <!--begin::Status-->
                        <span class="px-3 py-2 badge bg-primary text-inverse-primary">25 pending
                            tasks</span>
                        <!--end::Status-->
                    </div>
                    <!--end::Heading-->
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px"
                    ...
                    <!--begin::Menu item-->
                    <div class="px-5 menu-item">
                        <a href="../../demo39/dist/apps/projects/list.html" class="px-5 menu-link">
                    ...
                    <div class="px-5 menu-item" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div class="py-4 menu-sub menu-sub-dropdown w-175px">
                            ...
                            <!--begin::Menu item-->
                            <div class="px-3 menu-item">
                                <a href="../../demo39/dist/account/billing.html" class="px-5 menu-link">Billing</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="px-3 menu-item">
                    ...
                    <!--begin::Menu item-->
                    <div class="px-5 menu-item">
                        <a href="../../demo39/dist/account/statements.html" class="px-5 menu-link">My
                            Statements</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu separator-->
                    ...
                    <div class="px-5 menu-item" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div class="py-4 menu-sub menu-sub-dropdown w-175px">
                            ...
                            <!--begin::Menu item-->
                            <div class="px-3 menu-item">
                                <a href="../../demo39/dist/account/settings.html" class="px-5 menu-link d-flex">
                                    <span class="symbol symbol-20px me-4">
                    ...
                    <div class="px-5 my-1 menu-item">
                        <a href="../../demo39/dist/account/settings.html" class="px-5 menu-link">Account
                            Settings</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="px-5 menu-item">
                        <a href="{{ route('login') }}" class="px-5 menu-link">Sign Out</a>
                    </div>
                    <!--end::Menu item-->
                </div>
