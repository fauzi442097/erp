    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="border-0 shadow-none card rounded-0">
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="mb-10 timeline-content mt-n1">
                                ...
                                <div class="mb-5 pe-3">
                                    <!--begin::Title-->
                                    <a href="#" class="mb-2 text-gray-800 fs-5 fw-semibold text-hover-primary">3
                                        New Incoming
                                        Project Files:</a>
                                    <!--end::Title-->
                                    <!--begin::Description-->
            ...
            <div class="py-5 text-center card-footer" id="kt_activities_footer">
                <a href="../../demo39/dist/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View
                    All Activities
