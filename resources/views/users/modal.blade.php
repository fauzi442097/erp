                 ...
                 <form id="kt_modal_add_user_form" class="form" action="#">
                     ...
                     <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                         ...
                         <div class="fv-row mb-7">
                             <!--begin::Label-->
                             <label class="mb-5 d-block fw-semibold fs-6">Avatar</label>
                             <!--end::Label-->
                         ...
                         <div class="fv-row mb-7">
                             ...
                             <!--end::Label-->
                             <!--begin::Input-->
                             <input type="text" name="user_name" class="mb-3 form-control form-control-solid mb-lg-0"
                         ...
                         <div class="fv-row mb-7">
                             ...
                             <input type="email" name="user_email"
                                 class="mb-3 form-control form-control-solid mb-lg-0" placeholder="example@domain.com"
                             ...
                             <div class="d-flex fv-row">
                                 ...
                                 <div class="form-check form-check-custom form-check-solid">
                                     ...
                                     <label class="form-check-label" for="kt_modal_update_role_option_0">
                                         <div class="text-gray-800 fw-bold">Administrator</div>
                             ...
                             <div class="d-flex fv-row">
                                 ...
                                 <div class="form-check form-check-custom form-check-solid">
                                     ...
                                     <label class="form-check-label" for="kt_modal_update_role_option_1">
                                         <div class="text-gray-800 fw-bold">Developer</div>
                             ...
                             <div class="d-flex fv-row">
                                 ...
                                 <div class="form-check form-check-custom form-check-solid">
                                     ...
                                     <label class="form-check-label" for="kt_modal_update_role_option_2">
                                         <div class="text-gray-800 fw-bold">Analyst</div>
                             ...
                             <div class="d-flex fv-row">
                                 ...
                                 <div class="form-check form-check-custom form-check-solid">
                                     ...
                                     <label class="form-check-label" for="kt_modal_update_role_option_3">
                                         <div class="text-gray-800 fw-bold">Support</div>
                             ...
                             <div class="d-flex fv-row">
                                 ...
                                 <div class="form-check form-check-custom form-check-solid">
                                     ...
                                     <label class="form-check-label" for="kt_modal_update_role_option_4">
                                         <div class="text-gray-800 fw-bold">Trial</div>
