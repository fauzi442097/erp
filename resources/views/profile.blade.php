...
@section('content')
                    ...
                    <div class="mb-6 row">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                                ...
                                <option data-bs-offset="-21600" value="Mountain Time (US & Canada)">(GMT-06:00) Mountain
                                    Time (US & Canada)</option>
    ...
    <div class="mb-5 card mb-xl-10">
        ...
        <div class="border-0 cursor-pointer card-header" role="button" data-bs-toggle="collapse"
            ...
            <div class="m-0 card-title">
                <h3 class="m-0 fw-bold">Sign-in Method</h3>
            </div>
        </div>
        <!--end::Card header-->
        <!--begin::Content-->
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="flex-wrap d-flex align-items-center">
                    ...
                    <div id="kt_signin_email">
                        ...
                        <div class="text-gray-600 fw-semibold">support@keenthemes.com</div>
                    </div>
                    <!--end::Label-->
                    <!--begin::Edit-->
                    <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                        ...
                        <form id="kt_signin_change_email" class="form" novalidate="novalidate">
                            <div class="mb-6 row">
                                <div class="mb-4 col-lg-6 mb-lg-0">
                                    <div class="mb-0 fv-row">
                                        <label for="emailaddress" class="mb-3 form-label fs-6 fw-bold">Enter New Email
                                            Address</label>
                            ...
                            <div class="d-flex">
                                <button id="kt_signin_submit" type="button" class="px-6 btn btn-primary me-2">Update
                                    Email</button>
                    ...
                    <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                        ...
                        <form id="kt_signin_change_password" class="form" novalidate="novalidate">
                            <div class="mb-1 row">
                                <div class="col-lg-4">
                                    <div class="mb-0 fv-row">
                                        <label for="currentpassword" class="mb-3 form-label fs-6 fw-bold">Current
                                            Password</label>
                                        <input type="password" class="form-control form-control-lg form-control-solid"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-0 fv-row">
                                        <label for="newpassword" class="mb-3 form-label fs-6 fw-bold">New
                                            Password</label>
                                        <input type="password" class="form-control form-control-lg form-control-solid"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-0 fv-row">
                                        <label for="confirmpassword" class="mb-3 form-label fs-6 fw-bold">Confirm New
                                            Password</label>
                                        <input type="password" class="form-control form-control-lg form-control-solid"
    ...
    <div class="mb-5 card mb-xl-10">
        ...
        <div class="border-0 cursor-pointer card-header" role="button" data-bs-toggle="collapse"
            ...
            <div class="m-0 card-title">
                <h3 class="m-0 fw-bold">Notifications</h3>
            </div>
        </div>
        <!--begin::Card header-->
        <!--begin::Content-->
        <div id="kt_account_settings_notifications" class="collapse show">
            ...
            <form class="form">
                <!--begin::Card body-->
                <div class="pt-3 pb-4 card-body border-top px-9">
                    <!--begin::Table-->
                    <div class="table-responsive">
                        <table class="table align-middle border-gray-300 table-row-dashed gy-6">
                ...
                <div class="py-6 card-footer d-flex justify-content-end px-9">
                    ...
                    <button class="px-6 btn btn-primary">Save Changes</button>
                </div>
                <!--end::Card footer-->
            </form>
            <!--end::Form-->
